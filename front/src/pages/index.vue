<template>
	<div class="main-containers">
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0 20px","margin":" auto","overflow":"hidden","alignItems":"center","background":"#ffffff","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between","height":"64px","zIndex":"1002"}'>
			...
			<div v-if="true" :style='{"color":"#000","fontSize":"28px"}'>web端音乐播放器</div>
			<div>
        ...
        <div class="audioAnimation-box" :class="showType?'audioAnimation-box1':''" v-if="audio.length"
            ...
            <aplayer :float="true" :volume="1" repeat="repeat-all" ref="aplayer" id="aplayer" :server="audio[audioIndex]"
...
export default {
    ...
    mounted() {
        ...
        this.serverType = localStorage.getItem('serverType') ? true : false;
    },
    computed: {
        audioIndex: {
            get() {
